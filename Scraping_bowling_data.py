...
for i in range(0,len(australian_playerid)):
    url = 'http://stats.espncricinfo.com/ci/engine/player/' + australian_playerid[i] + '?class=1;template=results;type=' + "bowling"
    ...
    while(j<4):
        ...
        if country and country[0] == 'v England':
            ...
            if header[0] == 'Span':
                average_vs_england = tree.xpath('//*[@id="ciHomeContentlhs"]/div[3]/table[4]/tbody[1]/tr['+str(j)+']/td[11]/text()')
            else:
                average_vs_england = tree.xpath('//*[@id="ciHomeContentlhs"]/div[3]/table[4]/tbody[1]/tr['+str(j)+']/td[10]/text()')
            if(average_vs_england[0] != '-'):
                average_vs_england_index.append(float(average_vs_england[0]))
            else:
                average_vs_england_index.append(float(100))
            break
        j = j + 1
    if(j == 4):
        average_vs_england_index.append(float(35))
    ...
    while(j<5):
        ...
        if country and country[0] == 'in England':
            header = tree.xpath('//*[@id="ciHomeContentlhs"]/div[3]/table[4]/thead/tr/th[2]/a/text()')
            if header[0] == 'Span':
                average_in_england = tree.xpath('//*[@id="ciHomeContentlhs"]/div[3]/table[4]/tbody[2]/tr['+str(j)+']/td[11]/text()')
            else:
                average_in_england = tree.xpath('//*[@id="ciHomeContentlhs"]/div[3]/table[4]/tbody[2]/tr['+str(j)+']/td[10]/text()')
            if(average_in_england[0] != '-'):
                average_aus_in_england_index.append(float(average_in_england[0]))
            else:
                average_aus_in_england_index.append(float(100))
            break
        j = j + 1
    if(j == 5):
        average_aus_in_england_index.append(float(30))
    ...
    while(j<15):
        ...
        if year and year[0] == 'year 2015':
            header = tree.xpath('//*[@id="ciHomeContentlhs"]/div[3]/table[4]/thead/tr/th[2]/a/text()')
            if header[0] == 'Span':
                average_in_2015 = tree.xpath('//*[@id="ciHomeContentlhs"]/div[3]/table[4]/tbody[5]/tr['+str(j)+']/td[11]/text()')
            else:

                average_in_2015 = tree.xpath('//*[@id="ciHomeContentlhs"]/div[3]/table[4]/tbody[5]/tr['+str(j)+']/td[10]/text()')
            if(average_in_2015[0] != '-'):
                average_aus_in_2015_index.append(float(average_in_2015[0]))
            else:
                average_aus_in_2015_index.append(float(100))
            break
        j = j + 1
    if(j == 15):
        average_aus_in_2015_index.append(float(35))
...
for i in range(0,len(england_playerid)):
    url = 'http://stats.espncricinfo.com/ci/engine/player/' + england_playerid[i] + '?class=1;template=results;type=' + "bowling"
    player_page = requests.get(url,timeout=50)
    tree = html.fromstring(player_page.text)
    j = 1
    while(j<4):
        ...
        if country and country[0] == 'v Australia':
            header = tree.xpath('//*[@id="ciHomeContentlhs"]/div[3]/table[4]/thead/tr/th[2]/a/text()')
            if header[0] == 'Span':
                average_vs_australia = tree.xpath('//*[@id="ciHomeContentlhs"]/div[3]/table[4]/tbody[1]/tr['+str(j)+']/td[11]/text()')
            else:
                average_vs_australia = tree.xpath('//*[@id="ciHomeContentlhs"]/div[3]/table[4]/tbody[1]/tr['+str(j)+']/td[10]/text()')
            if(average_vs_australia[0] != '-'):
                average_vs_australia_index.append(float(average_vs_australia[0]))
            else:
                average_vs_australia_index.append(float(100))
            break
        j = j + 1
    if(j == 4):
        average_vs_australia_index.append(float(35))
    ...
    while(j<5):
        ...
        if country and country[0] == 'in England':
            ...
            if(average_in_england[0] != '-'):
                ...
                average_eng_in_england_index.append(float(100))
            break
        j = j + 1
    if(j == 5):
        average_eng_in_england_index.append(float(25))
    ...
    while(j<15):
        ...
        if year and year[0] == 'year 2015':
            ...
            if(average_in_2015[0] != '-'):
                ...
                average_eng_in_2015_index.append(float(100))
            break
        j = j + 1
    if(j == 15):
        average_eng_in_2015_index.append(float(35))

with open('bowling_data.csv', 'w') as fp:
